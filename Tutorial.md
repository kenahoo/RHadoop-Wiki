...
<pre>
    rhwordcount = function(input, output = NULL, <strong>pattern</strong> = " ") {
        revoMapReduce(input = input ,
            ...
            map = 
                  function(k,v) {lapply(strsplit(x = v,split = <strong>pattern</strong>)&#91;&#91;1&#93;&#93;,
