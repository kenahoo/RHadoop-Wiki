...
* Install the following R packages on each node: Rcpp, RJSONIO (>= 0.8-2),  digest, functional, stringr, plyr. Check the [DESCRIPTION file](https://github.com/RevolutionAnalytics/rmr2/blob/master/pkg/DESCRIPTION) for the most up to date list of dependencies.
